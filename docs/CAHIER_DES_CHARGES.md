...
## PARTIE 2 — Knowledge Base universelle — 🟡 DÉMARRÉ (13✅/0🟡/22⬜ sur 35, via les Étapes 2.1.1/2.1.2/2.1.3/2.1.4/2.1.5/2.1.6/2.1.7/2.1.8/2.1.9/2.1.10/2.1.11/2.1.12/2.1.13)
...
| ✅ Fait | 72 | 14.4% |
| 🟡 Partiel | 64 | 12.8% |
| ⬜ Non commencé | 364 | 72.8% |

**Complétion globale (/515, Partie 15 incluse en approximation)** :
- Strictement ✅ : **72/515 (~14.0%)**
- ✅ + 🟡 touchés d'une manière ou d'une autre : **136/515 (~26.4%)**
- Pondéré (✅=1, 🟡=0.5) : **~104.0/515 (~20.2%)** -- le chiffre le plus représentatif de l'avancement réel.

Mis à jour après Partie 2.1.13 (Import depuis GitHub -- issues, 2026-09-03) :
...
3. **Partie 2 (Knowledge Base multi-format), le reste** -- le cœur
   ...
   2.1.13 (GitHub -- issues) livrés -- 2.1.10 a introduit sa propre
   ...
   token serveur jamais transmis via Celery), et 2.1.13 a étendu le
   même module GitHub avec les issues, transformées en vrai Markdown
   avant de réutiliser le même pipeline une fois de plus. Aucune des
   quatre n'a introduit la moindre nouvelle colonne de base de données.
   Reste 2.1.14 à 2.1.19 (6 autres formats/sources d'import) et toute
