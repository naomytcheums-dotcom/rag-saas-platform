...
## PARTIE 2 — Knowledge Base universelle — 🟡 DÉMARRÉ (15✅/1🟡/19⬜ sur 35, via les Étapes 2.1.1/2.1.2/2.1.3/2.1.4/2.1.5/2.1.6/2.1.7/2.1.8/2.1.9/2.1.10/2.1.11/2.1.12/2.1.13/2.1.14/2.1.15/2.1.16)
...
- ✅ + 🟡 touchés d'une manière ou d'une autre : **139/515 (~27.0%)**
- Pondéré (✅=1, 🟡=0.5) : **~106.5/515 (~20.7%)** -- le chiffre le plus représentatif de l'avancement réel.

Mis à jour après Partie 2.1.16 (Import depuis Notion, 2026-09-04) :
...
3. **Partie 2 (Knowledge Base multi-format), le reste** -- le cœur
   ...
   livrés en ✅ ; 2.1.14 (Google Drive) livré en 🟡 -- 2.1.10 a introduit sa propre
   ...
   blocs converti en Markdown. Aucune des sept n'a introduit la moindre
   nouvelle colonne de base de données. Reste
   2.1.17 à 2.1.19 (3 autres formats/sources d'import) et toute
