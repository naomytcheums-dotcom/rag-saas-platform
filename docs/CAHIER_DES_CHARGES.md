...
## PARTIE 2 — Knowledge Base universelle — 🟡 DÉMARRÉ (5✅/0🟡/30⬜ sur 35, via les Étapes 2.1.1/2.1.2/2.1.3/2.1.4/2.1.5)
...
| ✅ Fait | 64 | 12.8% |
| 🟡 Partiel | 64 | 12.8% |
| ⬜ Non commencé | 372 | 74.4% |

**Complétion globale (/515, Partie 15 incluse en approximation)** :
- Strictement ✅ : **64/515 (~12.4%)**
- ✅ + 🟡 touchés d'une manière ou d'une autre : **128/515 (~24.9%)**
- Pondéré (✅=1, 🟡=0.5) : **~96.0/515 (~18.6%)** -- le chiffre le plus représentatif de l'avancement réel.

Mis à jour après Partie 2.1.5 (Import de documents HTML, 2026-09-03) :
...
3. **Partie 2 (Knowledge Base multi-format), le reste** -- le cœur
   ...
   (PDF), 2.1.2 (DOCX), 2.1.3 (TXT), 2.1.4 (Markdown) et 2.1.5 (HTML)
   livrés, même pipeline partagé -- reste 2.1.6 à 2.1.19 (14 autres
   formats d'import) et toute la Partie 2.2 (gestion des documents :
