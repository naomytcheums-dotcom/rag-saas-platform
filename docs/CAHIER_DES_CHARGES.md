...
**Score 1.2 : 7.5-8.5/10** (Owner ✅, Admin ✅, Super Admin ✅, Manager ✅, Member ✅, Viewer ✅, RBAC complet 🟡 -- moteur réel et vérifié mais pas encore branché sur la hiérarchie existante, permissions granulaires ⬜).
