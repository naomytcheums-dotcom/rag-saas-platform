...
## PARTIE 2 — Knowledge Base universelle — 🟡 DÉMARRÉ (15✅/3🟡/17⬜ sur 35, via les Étapes 2.1.1/2.1.2/2.1.3/2.1.4/2.1.5/2.1.6/2.1.7/2.1.8/2.1.9/2.1.10/2.1.11/2.1.12/2.1.13/2.1.14/2.1.15/2.1.16/2.1.17/2.1.18)
...
- ✅ + 🟡 touchés d'une manière ou d'une autre : **141/515 (~27.4%)**
- Pondéré (✅=1, 🟡=0.5) : **~107.5/515 (~20.9%)** -- le chiffre le plus représentatif de l'avancement réel.

Mis à jour après Partie 2.1.18 (Import depuis OneDrive, 2026-09-04) :
...
3. **Partie 2 (Knowledge Base multi-format), le reste** -- le cœur
   ...
   livrés en ✅ ; 2.1.14 (Google Drive), 2.1.17 (Confluence) et 2.1.18
   (OneDrive) livrés en 🟡 -- 2.1.10 a introduit sa propre
   ...
   rejet d'authentification, d'où son propre statut 🟡, et 2.1.18 a
   ...
   identiques. Aucune des neuf n'a introduit la moindre nouvelle
   colonne de base de données. Reste
   2.1.19 (1 dernier format/source d'import, purement local -- ZIP,
   aucune API externe) et toute la Partie 2.2 (gestion des documents :
   tags, versioning, réindexation, détection de doublons, sync). Gros
   chantier restant, à continuer de découper en sous-étapes.
