      ...
      <div className="inline-flex items-center gap-1">
        ...
        >
          <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M7 10v11" /><path d="M15 5.88 14 10h6.2a2 2 0 0 1 2 2.4l-1.6 8A2 2 0 0 1 18.6 22H7a2 2 0 0 1-2-2V12a2 2 0 0 1 2-2h1.5l4-8Z" />
          </svg>
        </button>
        <button
          type="button"
        ...
        >
          <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M17 14V3" /><path d="M9 18.12 10 14H3.8a2 2 0 0 1-2-2.4l1.6-8A2 2 0 0 1 5.4 2H17a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1.5l-4 8Z" />
          </svg>
        </button>
      </div>
