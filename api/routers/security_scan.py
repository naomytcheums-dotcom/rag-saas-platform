...
async def run_scan_endpoint(org_id: uuid.UUID, payload: RunScanRequest, caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def list_scans_endpoint(org_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def get_scan_endpoint(org_id: uuid.UUID, scan_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def list_vulnerabilities_endpoint(org_id: uuid.UUID, status_filter: VulnerabilityStatus | None = None, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def get_vulnerability_endpoint(org_id: uuid.UUID, vuln_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def update_vulnerability_endpoint(org_id: uuid.UUID, vuln_id: uuid.UUID, payload: VulnerabilityStatusUpdate, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def list_alerts_endpoint(org_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def dismiss_alert_endpoint(org_id: uuid.UUID, alert_id: uuid.UUID, caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def get_score_endpoint(org_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def get_report_endpoint(org_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def get_policies_endpoint(org_id: uuid.UUID, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
...
async def update_policies_endpoint(org_id: uuid.UUID, payload: SecurityPolicyUpdate, _caller: OrganizationMember = Depends(require_permission("security:manage")), db: AsyncSession = Depends(get_db)):
